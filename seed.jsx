// Seed data — initial questions parsed from user's provided exam material.
// Persisted only on first load; afterward, localStorage holds the user's edits.
...
const SEED_QUESTIONS = [
  // ===== 企業管理 =====
  {
    subjectId: "biz", type: "single", tags: ["ESG", "永續經營", "115預測"],
  ...
  {
    subjectId: "biz", type: "multi", tags: ["SWOT", "TOWS", "策略矩陣", "115預測"],
  ...
  {
    subjectId: "biz", type: "multi", tags: ["矩陣式組織", "組織結構"],
  ...
  {
    subjectId: "biz", type: "multi", tags: ["STP", "行銷"],
  ...
  // ===== 自來水法 =====
  {
    subjectId: "water", type: "single", tags: ["第2條", "主管機關"],
    stem: "依《自來水法》第2條規定，自來水事業之主管機關，在中央應為下列哪一個機關？",
    options: ["內政部", "衛生福利部", "水利主管機關", "環境保護部"],
    answer: ["C"],
    explanation: "《自來水法》第2條第1項：自來水事業之主管機關在中央為水利主管機關（即經濟部水利署）。",
  },
  {
    subjectId: "water", type: "single", tags: ["專營權", "第28條"],
    stem: "依《自來水法》第28條規定，自來水事業專營權之有效期間為多久？",
    options: ["十年", "二十年", "三十年", "四十年"],
    answer: ["C"],
    explanation: "專營權有效期間為三十年。",
  },
  {
    subjectId: "water", type: "single", tags: ["營業章程", "一度水"],
  ...
  {
    subjectId: "water", type: "single", tags: ["臨時用水", "保證金"],
  ...
  {
    subjectId: "water", type: "single", tags: ["遲延繳付費", "寬限期"],
  ...
  {
    subjectId: "water", type: "single", tags: ["竊水", "罰則", "刑期"],
  ...
  {
    subjectId: "water", type: "single", tags: ["追償", "竊水"],
    stem: "依《自來水法》第71條規定，自來水事業對於竊水者，應按其所裝用水設備及供水狀況等，追償多久期間之水費？",
    options: ["3個月以上6個月以下", "3個月以上1年以下", "6個月以上1年以下", "1年以上2年以下"],
    answer: ["B"],
    explanation: "對於竊水者追償三個月以上一年以下之水費。",
  },
  {
    subjectId: "water", type: "single", tags: ["外線", "定義"],
    stem: "依《台灣自來水公司營業章程》第11條規定，在未設置總量水器時，用戶用水設備之「外線」是指何處至量水器間之設備？",
    options: ["淨水廠", "配水管", "導水管", "分水栓"],
    answer: ["B"],
    explanation: "外線指配水管至量水器（水量計、水表）間之設備。",
  },
  {
    subjectId: "water", type: "single", tags: ["超收", "罰鍰倍數"],
  ...
  {
    subjectId: "water", type: "single", tags: ["停水", "基本費扣減"],
    stem: "依《台灣自來水公司營業章程》第32條規定，本公司因不可抗力之事由致停止供水連續超過多少小時者，當月基本費按停水日數比例扣減？",
    options: ["12小時", "24小時", "48小時", "72小時"],
    answer: ["B"],
    explanation: "連續超過二十四小時者，當月基本費按停水日數比例扣減。",
  },
  {
    subjectId: "water", type: "single", tags: ["市政公共用水", "減收"],
  ...
  {
    subjectId: "water", type: "single", tags: ["違規用水", "追收"],
    stem: "依《台灣自來水公司營業章程》第35條規定，用戶未經申請私自變更用水用途，如費率高於變更前者，台水公司最高得追收幾個月之水費差額？",
    options: ["3個月", "4個月", "5個月", "6個月"],
    answer: ["D"],
    explanation: "得視情節追收水費差額，最高以六個月為限。",
  },
  {
    subjectId: "water", type: "single", tags: ["按口計費"],
  ...
  {
    subjectId: "water", type: "single", tags: ["臨時用水", "加收"],
  ...
  {
    subjectId: "water", type: "single", tags: ["繳費期限"],
    stem: "依《台灣自來水公司營業章程》第33條規定，用戶應繳納之水費，應於通知之繳費日起算幾日內之繳費期限繳付？",
    options: ["14日", "21日", "30日", "60日"],
    answer: ["B"],
    explanation: "用戶應繳水費應於通知繳費日起二十一日內繳付。",
  },
  {
    subjectId: "water", type: "single", tags: ["停水", "公告"],
  ...
  {
    subjectId: "water", type: "single", tags: ["水籍註銷"],
  ...
  {
    subjectId: "water", type: "single", tags: ["量水器", "故障"],
  ...
  {
    subjectId: "water", type: "single", tags: ["遲延繳付費", "下限"],
    stem: "依《台灣自來水公司營業章程》第33條規定，用戶若逾期繳費被加收遲延繳付費，若經計算後其遲延繳付費未滿多少元者，一律以該金額計收？",
    options: ["新台幣五元", "新台幣十元", "新台幣二十元", "免予計收"],
    answer: ["A"],
    explanation: "遲延繳付費未滿新台幣五元者，以新台幣五元計。",
  },
  {
    subjectId: "water", type: "single", tags: ["自用自來水設備", "第21條"],
    stem: "依《自來水法》第21條規定，所稱「自用自來水設備」，是指專供自用之自來水設備，且其每日出水能力（出水量）在多少立方公尺以上者？",
    options: ["二十立方公尺", "三十立方公尺", "五十立方公尺", "六十立方公尺"],
    answer: ["B"],
    explanation: "專供自用且出水量每日在三十立方公尺以上者。",
  },
  {
    subjectId: "water", type: "single", tags: ["停水", "催繳"],
    stem: "依據《台灣自來水公司營業章程》第39條規定，用戶若有欠繳應付各項費用之情形，經台水公司限期催繳後仍不清付者，逾期達多久時間，台水公司得予停止供水？",
    options: ["半個月", "一個月", "二個月", "三個月"],
    answer: ["C"],
    explanation: "營業章程第39條：「欠繳應付各費逾期二個月，經限期催繳仍不清付者」得予停止供水。",
  },
  {
    subjectId: "water", type: "single", tags: ["市政公共用水", "權責"],
    stem: "依《自來水法》第67條規定，市政公共用水之優待辦法，依法應由下列何者定之？",
    options: ["經濟部（中央主管機關）", "自來水事業所在地之直轄市、縣（市）政府", "中央主管機關會同內政部", "水價評議委員會"],
    answer: ["C"],
    explanation: "自來水法第67條：市政公共用水之優待辦法，由中央主管機關會同內政部定之。考生常誤選地方政府。",
  },
  {
    subjectId: "water", type: "single", tags: ["水源保育與回饋費"],
    stem: "依《自來水法》第 12-2 條規定，於水質水量保護區內取用地面水或地下水之公共給水公用事業，得於其公用事業費用（水費）之外，附徵多少比例之費額？",
    options: ["百分之一以上百分之五以下", "百分之三以上百分之十以下", "百分之五以上百分之十五以下", "百分之七以上百分之二十以下"],
    answer: ["C"],
    explanation: "得於公用事業費用外附徵百分之五以上百分之十五以下之費額。",
  },
  {
    subjectId: "water", type: "single", tags: ["復水", "基本費"],
    stem: "若某用戶因欠費被停止供水，在其停水原因消滅並申請復水時，若其「停水期間在二年以下者」，除復水費及積欠費用外，應按用水設備口徑繳納停水期間多少比例之基本費？",
    options: ["全額繳納", "三分之二基本費", "二分之一基本費", "免予繳納"],
    answer: ["C"],
    explanation: "營業章程第9條第2項：應按用水設備口徑，繳納停水期間二分之一基本費。",
  },
  {
    subjectId: "water", type: "single", tags: ["遲延繳付費", "加收比例"],
    stem: "依《台灣自來水公司營業章程》第 33 條規定，用戶若逾期繳納水費，自繳費期限截止後起算，於第幾天起至第十四天繳費者，台水公司將按應繳水費之「百分之一」加收遲延繳付費？",
    options: ["第五天", "第七天", "第八天", "第十五天"],
    answer: ["C"],
    explanation: "逾期 7 天內免計；自第八天起至第十四天繳費者，加收百分之一遲延費。",
  },
  {
    subjectId: "water", type: "single", tags: ["臨時用水", "違章"],
    stem: "下列哪一種臨時用水種類，「並非」加收百分之五十，而是「按普通用水水價加收百分之二十」計收水費？",
    options: ["建物改建用水", "以建築執照申請之工程用水", "經前臺灣省政府核准之違章臨時用水", "經主管機關核准之短期活動用水"],
    answer: ["C"],
    explanation: "違章臨時用水加收20%，其餘臨時用水均加收50%。",
  },
  {
    subjectId: "water", type: "single", tags: ["水質水量保護區", "例外"],
    stem: "依《自來水法》第 11 條規定，下列哪一項行為「並未」明確列在該條文所列舉的禁止或限制行為中？",
    options: ["高爾夫球場之興建或擴建", "核能或其他能源之開發、放射性廢棄物儲存場所之興建", "居民非營利之家用生活耕作或非營利公共設施", "土石採取或探礦、採礦致污染水源"],
    answer: ["C"],
    explanation: "第11條第2項但書：居民生活或地方公共建設所必要且經主管機關核准者，不在此限。",
  },
  {
    subjectId: "water", type: "multi", tags: ["供水種類"],
    stem: "依《台灣自來水公司營業章程》第4條規定，本公司所規範之供水種類包括下列哪些選項？",
    options: ["農業用水", "工業用水", "船舶用水", "臨時用水"],
    answer: ["B","C","D"],
    explanation: "六種供水種類：普通、工業、商業、船舶、市政公共、臨時用水，「不包含」農業用水。",
  },
  {
    subjectId: "water", type: "multi", tags: ["代收費用"],
    stem: "依《台灣自來水公司營業章程》第26條規定，下列哪些費用屬於台水公司「得依法隨水費附徵或代收」之費用項目？",
    options: ["水源保育與回饋費", "清除處理費", "污水下水道使用費", "水污染防治費"],
    answer: ["A","B","C"],
    explanation: "得代收：水源保育與回饋費、清除處理費、污水下水道使用費；水污染防治費非屬代收範圍。",
  },
  {
    subjectId: "water", type: "multi", tags: ["水質水量保護區"],
    stem: "依《自來水法》第11條規定，主管機關劃定公布水質水量保護區後，依法應禁止或限制下列哪些貽害水質與水量之行為？",
    options: ["濫伐林木或濫墾土地", "設置垃圾掩埋場或焚化爐", "興建或擴建高爾夫球場", "露營或一般觀光健行"],
    answer: ["A","B","C"],
    explanation: "一般觀光健行或露營未列在法定的禁止或限制行為中。",
  },
  {
    subjectId: "water", type: "multi", tags: ["稅賦減免"],
    stem: "依《自來水法》第12-1條規定，水質水量保護區依都市計畫程序劃定為水源特定區者，其土地應視限制程度減免下列哪些稅賦？",
    options: ["土地增值稅", "贈與稅", "遺產稅", "所得稅"],
    answer: ["A","B","C"],
    explanation: "應減免：土地增值稅、贈與稅、遺產稅；不包含所得稅。",
  },
  {
    subjectId: "water", type: "multi", tags: ["專營權證"],
    stem: "依《自來水法》第27條規定，自來水事業專營權證上應明確載明下列哪些事項？",
    options: ["水權證字號", "供水區域", "資本總額", "預估營業收入"],
    answer: ["A","B","C"],
    explanation: "專營權證應載明：名稱及所在地、負責人、水權證字號、供水區域、主要供水設備、資本總額等；預估營業收入不屬於記載項目。",
  },
  {
    subjectId: "water", type: "multi", tags: ["必要設備", "第43條"],
    stem: "依《自來水法》第43條規定，自來水事業依法應具有必要之設備，下列哪些選項屬於法律規定的必要設備？",
    options: ["取水設備及貯水設備", "導水設備及淨水設備", "送水設備及配水設備", "海水淡化設備"],
    answer: ["A","B","C"],
    explanation: "必要設備：取水、貯水、導水、淨水、送水、配水（共六大設備）。",
  },
  {
    subjectId: "water", type: "multi", tags: ["停水事由"],
    stem: "依《台灣自來水公司營業章程》第39條規定，用戶有下列哪些情形之一時，台水公司得予停止供水？",
    options: ["有竊水行為，證據確實者", "欠繳應付各費逾期二個月，經限期催繳仍不清付者", "無正當理由拒絕本公司檢查其用水設備或用水情形者", "月用水度數連續三個月出現暴增者"],
    answer: ["A","B","C"],
    explanation: "用水度數暴增不屬於可依法停水的事由。",
  },
  {
    subjectId: "water", type: "multi", tags: ["竊水行為"],
    stem: "依《台灣自來水公司營業章程》第40條及《自來水法》第98條規定，下列哪些行為屬於依法認定的「竊水」行為？",
    options: ["未經本公司許可，在本公司供水管線上取水者", "繞越所裝量水器私接水管者", "毀損或改變量水器之構造致量水器失效或不準確者", "用戶自行雇用不具證照之技工更換內線水龍頭者"],
    answer: ["A","B","C"],
    explanation: "自行更換水龍頭與竊水無涉。",
  },
  {
    subjectId: "water", type: "multi", tags: ["臨時用水", "分類"],
    stem: "依《台灣自來水公司營業章程》第37條規定，下列哪些選項屬於台水公司規定的「臨時用水」分類範疇？",
    options: ["建物改建：建築物拆除或重建時之短期用水", "工程用水：以建築執照申請之工程用水", "違章臨時用水：經前臺灣省政府核准之違章建築用水", "農業灌溉：因天旱臨時申請之農業救荒用水"],
    answer: ["A","B","C"],
    explanation: "農業灌溉不屬於台水規定的臨時用水分類。",
  },
  {
    subjectId: "water", type: "multi", tags: ["白晝檢查"],
    stem: "依《台灣自來水公司營業章程》第18條規定，台水公司得派穿著制服並配戴識別證之員工，於「白晝」非有正當理由用戶不得拒絕進入執行下列哪些事項？",
    options: ["查錄用水量", "檢查用戶用水設備", "封印、裝表或換表", "向用戶進行民意滿意度問卷調查"],
    answer: ["A","B","C"],
    explanation: "法定不得拒絕之檢查事項：檢查用水設備、查錄用水量、裝拆換表、封印、取締違章用水；並不包含推銷或問卷調查。",
  },
  {
    subjectId: "water", type: "multi", tags: ["停水扣減"],
  ...
  {
    subjectId: "water", type: "multi", tags: ["竊水", "消防栓"],
    stem: "依《自來水法》第98條與《台灣自來水公司營業章程》第40條規定，下列哪些具體行為在法律定義上「即構成竊水行為」？",
    options: ["未經自來水事業許可，在供水管線上取水者", "繞越所裝量水器私接水管者", "毀損或改變量水器之構造或用其他方式致量水器失效或不準確者", "因發生火災，附近居民未經許可自行開啟公用消防栓進行緊急滅火者"],
    answer: ["A","B","C"],
    explanation: "「未經許可擅自開啟消火栓取水者為竊水。但因消防需要而開啟，不在此限。」緊急滅火不屬於竊水。",
  },
  {
    subjectId: "water", type: "multi", tags: ["承裝商", "違規處分"],
  ...
  {
    subjectId: "water", type: "multi", tags: ["簡易自來水事業"],
    ...
    options: [
      ...
      "簡易自來水事業得由所有權人申請自來水公司同意後，無償移交並由台水接管或代管",
    ],
    answer: ["A","B","D"],
  ...
  },
  {
    ...
    options: ["to implement", "implementing", "implemented", "implement"],
    answer: ["B"],
    explanation: "動詞 suggest（建議）後若直接跟動詞，必須使用動名詞（V-ing），故選 (B) implementing。",
  },
  {
    subjectId: "lang", type: "single", tags: ["啟封詞", "書信"],
    stem: "若台水營運所員工要寫信給「女性客戶」，下列哪一個啟封詞最不恰當？",
    options: ["啟", "芳啟", "敬啟", "大啟"],
    answer: ["C"],
    explanation: "「敬啟」意指請對方「恭敬地開啟」，在商務與社交禮儀上極為不敬，是常見陷阱題。",
  },
  {
    subjectId: "lang", type: "single", tags: ["題辭", "升遷"],
    stem: "台水公司的王經理因績效卓越，於年中榮升為總公司處長，同仁們欲合資贈送祝賀匾額。下列題辭何者最不適合用於「賀人升遷」？",
    options: ["青雲直上", "業紹陶朱", "功在桑梓", "德業長昭"],
    answer: ["D"],
    explanation: "(D)「德業長昭」是專用於「哀悼男喪」的輓聯題辭，絕不可用於升遷。",
  },
  {
    subjectId: "lang", type: "single", tags: ["古代文學家", "蘇軾"],
  ...
  {
    subjectId: "lang", type: "single", tags: ["英文單字", "conserve"],
  ...
  },
  {
    ...
    options: ["I can't afford it", "I'm sorry to hear that", "It's none of my business", "Thanks for the vote of confidence"],
    answer: ["B"],
    explanation: "客戶抱怨水費突增，店員最合適的應答為「I'm sorry to hear that」，隨後提出解決方案。",
  },
  {
    subjectId: "lang", type: "multi", tags: ["年齡代稱"],
    stem: "古語中的年齡代稱常出現在國文考題中。下列關於年齡代稱與實際歲數的配對，哪些選項完全正確？",
    options: ["及笄之年：女子滿十五歲", "束髮之年：男子滿十五歲", "弱冠之年：男子滿二十歲", "不惑之年：人滿五十歲"],
    answer: ["A","B","C"],
    explanation: "「不惑之年」依孔子論述是指「四十歲」，五十歲為知天命之年。",
  },
  {
    subjectId: "lang", type: "multi", tags: ["儒墨", "諸子百家"],
  ...
  {
    subjectId: "lang", type: "multi", tags: ["英文文法", "讓步"],
  ...
  {
    subjectId: "lang", type: "multi", tags: ["英文單字", "影響"],
    ...
    options: ["affect", "influence", "defend", "impact"],
    answer: ["A","B","D"],
    explanation: "affect / influence / impact 均有「影響」之意；defend（防禦）文意不符。",
  },
  {
    subjectId: "lang", type: "multi", tags: ["公文", "書信"],
